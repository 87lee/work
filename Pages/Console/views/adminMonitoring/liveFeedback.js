//@ sourceURL=adminMonitoring.liveFeedback.js
var myData = {};
...
function updateTable(page){
	AjaxPost('/Report/getUsersReport?page='+ page +'&pageSize=' + pageSize, myData.pData, function(data){
...
function createBack(data, page){
	...
	$('#searchTable').dataTable({
		...
		"createdRow": function(nRow, aData, iDataIndex) {
			tableTdDownload(9, nRow, aData[9]);
		},
		"language": {
			"zeroRecords": "没有检索到数据",
			"infoEmpty": "没有数据"
