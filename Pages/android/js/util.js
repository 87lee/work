...
var myConfig = {
    ...
    logOutUrl: '/Pages/android/index.html',
    addBtn: '<a class="btn my-btn addBtn" href="javascript:"><i class="iconfont icon-51"></i>&nbsp;新增</a>',
    editBtn: '<a class="btn my-btn editBtn" href="javascript:"><i class="iconfont icon-yonghufankui03"></i>&nbsp;修改</a>',
...
//监听自定义分页
function listenMyPage(table, nPage, fn) {
    table = table || 'myTable';
