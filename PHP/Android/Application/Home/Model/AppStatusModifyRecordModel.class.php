<?php
	...
	class AppStatusModifyRecordModel extends \Think\Model
	{
		...
		public function addStatusRecord($put,$status)
		{
			...
			if (!empty($put['publisher'])&&!empty($put['versionCode'])&&isset($put['passTest'])&&!empty($put['pkgName'])&&!empty($put['versionName'])) {
