<?php
	...
	class QuickEntrySlotBindAppDesktop extends \Think\Model
	{
		protected $tableName = 'quick_entry_slot_bind_app';
		...
		public function addQuickEntrySlotBindApp($options)
		{
		...
		public function modifyQuickEntrySlotBindApp($quickEntryId,$options)
		{
		...
		public function deleteQuickEntrySlotBindApp($quickEntryId)
		{
			if ($this->where("`quick_entry_id`=%d",array($quickEntryId))->find()) {
		...
		public function deleteQuickEntrySlotBindAppForIDArr($quickEntryIdArr)
		{
