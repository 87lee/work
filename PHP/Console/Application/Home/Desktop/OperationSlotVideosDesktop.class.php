<?php
	...
	class OperationSlotVideosDesktop extends \Think\Model
	{
		protected $tableName = 'operation_slot_videos';
		protected $connection = 'DB_DESKTOP';
		protected $_map = array(
			'operationId' =>'operation_id',
		);
		public function addOperationSlotVideosArr($operationId,$options)
		{
		...
		public function modifyOperationSlotVideosArr($operationId,$options)
		{

			$this->deleteOperationSlotVideosArr($operationId);
			$this->addOperationSlotVideosArr($operationId,$options);

		}
		public function deleteOperationSlotVideosArr($operationId)
		{
		...
		public function deleteVideosArrForOperationSlotArr($operationIdSql)
		{
		...
		public function getValArrForOperationId($OperationId)
		{
			return $this->field("`duration`,`url`")->where("`operation_id`=%d",array($OperationId))->select();
		}
